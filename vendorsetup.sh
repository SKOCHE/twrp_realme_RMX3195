...
if [ -f $FOX_MANIFEST_ROOT/bootable/recovery/orangefox_defaults.go -a -f $FOX_MANIFEST_ROOT/bootable/recovery/orangefox.mk ]; then
    ...
    # Magisk
    export FOX_USE_SPECIFIC_MAGISK_ZIP="$FOX_MANIFEST_ROOT/device/realme/RMX3195/Magisk/Magisk-v25.2.zip"
    ...
    # Backup
    export OF_QUICK_BACKUP_LIST="/recovery;persist;/data;/nvram;"
